// frontend/src/Dashboard/EditPartner.js
...
const EditPartner = () => {
  ...
  useEffect(() => {
    ...
    if (partner) {
      setFormData({
        ...
        total_payout: partner.total_payout,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(
        updatePartnerData({ partnerId, partnerData: formData })
      ).unwrap();
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen absolute top-20 right-0 w-[80%]">
      <h2 className="text-2xl font-semibold mb-6 mt-2">Edit Partner</h2>
        ...
        <div className="bg-white rounded-2xl shadow-md w-full max-w-3xl p-8 mt-9 pt-20 relative">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center gap-4 mt-6">
              ...
              >
                {partnerLoading ? "Updating..." : "Update"}
              </button>
            </div>
          </form>
